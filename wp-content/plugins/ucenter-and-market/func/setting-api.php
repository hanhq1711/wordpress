...
function um_get_option_labels(){
	...
	$ucenter_fields = array(
		...
		'open_uctg'	=> array('title'=>'开启投稿',	'type'=>'checkbox',	'description'=>'开启投稿功能'),
	);
	...
	$credit_fields = array(
		'exchange_ratio'	=> array('title'=>'现金牛币兑换比率',	'type'=>'text',	'description'=>'1元所能兑换的牛币数，用于计算牛币充值'),
		'new_reg_credit'	=> array('title'=>'新用户注册奖励',	'type'=>'text',	'description'=>'新用户首次注册奖励牛币'),
		'daily_sign_credit'	=> array('title'=>'每日签到牛币奖励',	'type'=>'text',	'description'=>''),
		'comment_credit'	=> array('title'=>'评论一次奖励牛币',	'type'=>'text',	'description'=>''),
		'comment_credit_times'	=> array('title'=>'每日评论奖励牛币次数',	'type'=>'text',	'description'=>'每天通过评论获得牛币的最大次数，超出后将不再获得牛币'),
		'like_article_credit'	=> array('title'=>'文章互动可得牛币,点击喜欢',	'type'=>'text',	'description'=>''),
		'like_article_credit_times'	=> array('title'=>'文章互动可得牛币每日次数',	'type'=>'text',	'description'=>''),
		//'contribute_credit'	=> array('title'=>'投稿一次奖励牛币',	'type'=>'text',	'description'=>''),
		//'contribute_credit_times'	=> array('title'=>'每日投稿获得牛币次数',	'type'=>'text',	'description'=>'每天通过投稿获得牛币的最大次数，超出后将不再获得牛币'),
		'aff_visit_credit'	=> array('title'=>'访问推广一次奖励牛币',	'type'=>'text',	'description'=>'通过专属推广链接推广用户访问一次奖励牛币'),
		'aff_visit_credit_times'	=> array('title'=>'每日访问推广奖励牛币次数',	'type'=>'text',	'description'=>'每天通过访问推广获得牛币的最大次数，超出后将不再获得牛币'),
		'aff_reg_credit'	=> array('title'=>'注册推广一次奖励牛币',	'type'=>'text',	'description'=>'通过专属推广链接推广新用户注册一次所奖励牛币'),
		'aff_reg_credit_times'	=> array('title'=>'每日注册推广奖励牛币次数',	'type'=>'text',	'description'=>'每天通过注册推广获得牛币的最大次数，超出后将不再获得牛币'),
		'source_download_credit'	=> array('title'=>'发布资源被下载奖励牛币',	'type'=>'text',	'description'=>'作者发布的资源被用户下载后获得牛币奖励，不限次数'),
		'contribute_cost_credit'	=> array('title'=>'发布文章所需牛币',	'type'=>'text',	'description'=>'用户发布文章需要花费的牛币'),
		'contribute_free_images'	=> array('title'=>'发布文章免费附带图片数',	'type'=>'text',	'description'=>'用户发布文章可免费附带的图片数量'),
		'contribute_image_credit'	=> array('title'=>'发布文章超额图片牛币价格',	'type'=>'text',	'description'=>'用户发布文章附带超额图片的价格，为每个超额图片的牛币单价')
	...
	$sections = array( 
    	...
    	'credit'		=>array('title'=>'牛币设置',		'fields'=>$credit_fields,	'callback'=>'',	),
...
function um_option_defaults(){
	...
	$defaults = array(
			...
			'font_awesome'			=>	1,
			'bing_login_bg'			=>	0,
			'contribute_free_images'=>	3,
			'contribute_image_credit'=>	5,
			'contribute_cost_credit'=>	10
		);
	return $defaults;
}
